...
$idVal = $nameVal = $phoneVal = $passwordVal = $repassVal = "";
...
<div class = "container">
    ...
    <div>
        <div class="alert alert-success capitallize"><p class="label-padding highlight">User Created</p></div>
    </div>
    <?php endif;?>
    <br/>
    <form action = "NewUser.php" role="form" method="post">
        <input type="hidden" name="hiddenKey" value="<?php echo $_SESSION['key'] ?>"/>
        <div class="row horizontal-margin vertical-margin form-group">
            <div class ="col-sm-2 label-padding highlight label-length">User ID:</div>
            <div class = "col-sm-3 field-length">
        ...
        <div class="row horizontal-margin vertical-margin form-group">
            ...
            <div class = "col-sm-3 field-length">
                <input type = "password" class = "form-control" name = "password" placeholder="Enter password" <?php echo "value = '$passwordVal'" ?>/>
            </div>
         ...
         <div class="row horizontal-margin vertical-margin form-group">
            ...
            <div class = "col-sm-3 field-length">
                <input type = "password" class = "form-control" name = "password2" placeholder="Confirm Password" <?php echo "value = '$repassVal'" ?>/>
            </div>
            <div class="error col-sm-6"><?php echo $repasswordError ?></div>
        </div>
        <div class="row  h-margin v-margin">
            <div class="col-sm-1 btn-submit"><button type = "submit" name = "btnSignup" class = "btn btn-primary" >Submit</button></div>
            <div class="col-sm-1 btn-clear"><button type ="submit" class = "btn btn-primary" name = "btnclear">Clear</button></div>
        </div>
    </form>
</div>
