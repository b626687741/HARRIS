...
<div class="container">
    ...
    <br/>
    <?php if ($result != ''): ?>
    <div class="alert alert-success capitallize"><p class="label-padding highlight"><?php echo $result ?></p></div>
    <?php elseif($error != ''):?>
    <div class="alert alert-danger capitallize"><?php echo $error ?></div>
    <?php else:?>
    ...
    <form action="AddFriend.php" role="form" method="post">
        ...
        <div class="row horizontal-margin vertical-margin">
            ...
            <div class="col-sm-2"><button type = "submit" name = "btnSubmit" class = "btn btn-primary" >Send Friend Request</div>
        </div>
    </form>
</div>
