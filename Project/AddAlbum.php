...
<div class = "container">
    ...
    <p class="label-padding">Welcome <b><?php echo "$userName" ?>!</b> (not you? change user <a href="Login.php">here</a>)</p>
    <br/>

    <div id="success" style="display: none" class="alert alert-success" >
        <strong>Success!</strong> Created Successfully!
    </div>
    <form action="AddAlbum.php" role="form" method="post" onsubmit="ConfirmAlbum()">
        ...
        <div class="row  v-margin label-padding">
            <div class="col-sm-1 btn-submit "><button type = "submit" name = "btnSubmit" class = "btn btn-primary btn-block" >Submit</button></div>
            <div class="col-sm-1 btn-clear "><button type ="submit"  class = "btn btn-primary btn-block" name = "btnclear">Clear</button></div>
        </div>
    </form>
</div>
...
<script>
    function ConfirmAlbum() {
        alert('Succesfully Created New Album');
    }
</script>
