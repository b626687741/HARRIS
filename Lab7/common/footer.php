  <footer style="position: fixed; bottom: 0;
    ...
    <script src="./AlgCommon/Scripts/jquery-2.2.4.min.js" type="application/javascript"></script>
    <script src="./AlgCommon/Contents/js/bootstrap.min.js" type="application/javascript"></script>
</body>
</html>